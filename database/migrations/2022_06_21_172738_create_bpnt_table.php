...
class CreateBpntTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bpnt', function (Blueprint $table) {
            ...
            $table->tinyInteger('bansos_bpnt')->comment('1: Ya, 2: Tidak')->nullable();
            $table->tinyInteger('bansos_bpnt_ppkm')->comment('1: Ya, 2: Tidak')->nullable();
            $table->timestamps();
        });
    }
