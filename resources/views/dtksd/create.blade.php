...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('dtksd.store') }}" method="post">
                    @csrf
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="periode">Periode</label>
                            <input type="date" class="form-control @error('periode') is-invalid @enderror" name="periode" placeholder="Masukkan Periode ..." value="{{ old('periode') }}">
