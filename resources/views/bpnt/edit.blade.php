...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('bpnt.update', $bpnt) }}" method="post">
                    @csrf @method('patch')
                    <div class="row">
                        <div class="form-group col-md-6">
                            <label class="form-control-label" for="id_dtks">ID DTKS</label>
                            <input type="text" class="form-control @error('id_dtks') is-invalid @enderror" name="id_dtks" placeholder="Masukkan ID DTKS ..." value="{{ old('id_dtks', $bpnt->id_dtks) }}">
                            @error('id_dtks')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-12">
                            <label class="form-control-label" for="alamat">Alamat</label>
                            <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" placeholder="Masukkan Alamat ...">{{ old('alamat', $bpnt->alamat) }}</textarea>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('dusun_id') is-invalid @enderror" name="dusun_id" id="dusun_id">
                                ...
                                @foreach ($dusun as $item)
                                    <option value="{{ $item->id }}" {{ old('dusun_id', $bpnt->dusun_id) == $item->id ? 'selected' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('rts_id') is-invalid @enderror" name="rts_id" id="rts_id">
                                ...
                                @foreach ($rts as $item)
                                    <option value="{{ $item->id }}" {{ old('rts_id', $bpnt->rts_id) == $item->id ? 'selected' : ''  }}>{{ $item->nomor }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('rws_id') is-invalid @enderror" name="rws_id" id="rws_id">
                                ...
                                @foreach ($rws as $item)
                                    <option value="{{ $item->id }}" {{ old('rws_id', $bpnt->rws_id) == $item->id ? 'selected' : ''  }}>{{ $item->nomor }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('kk') is-invalid @enderror" name="kk" placeholder="Masukkan KK ..." value="{{ old('kk', $bpnt->kk) }}">
                            @error('kk')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="nik">NIK</label>
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" placeholder="Masukkan NIK ..." value="{{ old('nik', $bpnt->nik) }}">
                            @error('nik')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="nama">Nama</label>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Masukkan Nama ..." value="{{ old('nama', $bpnt->nama) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" placeholder="Masukkan Tanggal Lahir ..." value="{{ old('tanggal_lahir', $bpnt->tanggal_lahir) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" placeholder="Masukkan Tempat Lahir ..." value="{{ old('tempat_lahir', $bpnt->tempat_lahir) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin">
                                ...
                                <option value="1" {{ old('jenis_kelamin', $bpnt->jenis_kelamin) == 1 ? 'selected' : ''  }}>Laki-laki</option>
                                <option value="2" {{ old('jenis_kelamin', $bpnt->jenis_kelamin) == 2 ? 'selected' : ''  }}>Perempuan</option>
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('pekerjaan_id') is-invalid @enderror" name="pekerjaan_id" id="pekerjaan_id">
                                ...
                                @foreach ($pekerjaan as $item)
                                    <option value="{{ $item->id }}" {{ old('pekerjaan_id', $bpnt->pekerjaan_id) == $item->id ? 'selected' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" placeholder="Masukkan Nama Ibu ..." value="{{ old('nama_ibu', $bpnt->nama_ibu) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('status_hubungan_dalam_keluarga_id') is-invalid @enderror" name="status_hubungan_dalam_keluarga_id" id="status_hubungan_dalam_keluarga_id">
                                ...
                                @foreach ($status_hubungan_dalam_keluarga as $item)
                                    <option value="{{ $item->id }}" {{ old('status_hubungan_dalam_keluarga_id', $bpnt->status_hubungan_dalam_keluarga_id) == $item->id ? 'selected' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('keterangan_padan') is-invalid @enderror" name="keterangan_padan" id="keterangan_padan">
                                ...
                                <option value="1" {{ old('keterangan_padan',$bpnt->keterangan_padan) == 1 ? 'selected' : ''  }}>Padan</option>
                                <option value="2" {{ old('keterangan_padan',$bpnt->keterangan_padan) == 2 ? 'selected' : ''  }}>Tidak Padan</option>
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('bansos_bpnt') is-invalid @enderror" name="bansos_bpnt" id="bansos_bpnt">
                                <option value="">Apakah menerima Bansos BPNT?</option>
                                <option value="1" {{ old('bansos_bpnt', $bpnt->bansos_bpnt) == 1 ? 'selected' : ''  }}>Ya</option>
                                <option value="2" {{ old('bansos_bpnt', $bpnt->bansos_bpnt) == 2 ? 'selected' : ''  }}>Tidak</option>
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('bansos_bpnt_ppkm') is-invalid @enderror" name="bansos_bpnt_ppkm" id="bansos_bpnt_ppkm">
                                <option value="">Apakah menerima Bansos BPNT-PPKM?</option>
                                <option value="1" {{ old('bansos_bpnt_ppkm', $bpnt->bansos_bpnt_ppkm) == 1 ? 'selected' : ''  }}>Ya</option>
                                <option value="2" {{ old('bansos_bpnt_ppkm', $bpnt->bansos_bpnt_ppkm) == 2 ? 'selected' : ''  }}>Tidak</option>
                            </select>
        ...
        if ($("#dusun").val() != "") {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#detail_dusun_id").val("{{ $bpnt->detail_dusun_id }}");
                }
            });
        } else {
            $('#detail_dusun_id').html(`<option value="">Pilih RT/RW</option>`);
