...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('kip.update', $kip) }}" method="post">
                    @csrf @method('patch')
                    <div class="row">
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="peserta_didik_id">Peserta Didik Id</label>
                            <input type="text" class="form-control @error('peserta_didik_id') is-invalid @enderror" name="peserta_didik_id" placeholder="Masukkan Peserta Didik ID ..." value="{{ old('peserta_didik_id',$kip->peserta_didik_id) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('sekolah_id') is-invalid @enderror" name="sekolah_id" placeholder="Masukkan Sekolah ID ..." value="{{ old('sekolah_id', $kip->sekolah_id) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('npsn') is-invalid @enderror" name="npsn" placeholder="Masukkan NPSN ..." value="{{ old('npsn', $kip->npsn) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomenklatur') is-invalid @enderror" name="nomenklatur" placeholder="Masukkan Nomenklatur ..." value="{{ old('nomenklatur', $kip->nomenklatur) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('rombel_id') is-invalid @enderror" name="rombel_id" id="rombel_id">
                                ...
                                @foreach ($rombel as $item)
                                    <option value="{{ $item->id }}" {{ old('rombel_id', $kip->rombel_id) == $item->id ? 'selected' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_pd') is-invalid @enderror" name="nama_pd" placeholder="Masukkan Nama Penerima Dana ..." value="{{ old('nama_pd', $kip->nama_pd) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" placeholder="Masukkan Nama Ibu ..." value="{{ old('nama_ibu', $kip->nama_ibu) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_ayah') is-invalid @enderror" name="nama_ayah" placeholder="Masukkan Nama Ayah ..." value="{{ old('nama_ayah', $kip->nama_ayah) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" placeholder="Masukkan Tanggal Lahir ..." value="{{ old('tanggal_lahir', $kip->tanggal_lahir) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" placeholder="Masukkan Tempat Lahir ..." value="{{ old('tempat_lahir', $kip->tempat_lahir) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nisn') is-invalid @enderror" name="nisn" placeholder="Masukkan NISN ..." value="{{ old('nisn', $kip->nisn) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin">
                                ...
                                <option value="1" {{ old('jenis_kelamin',$kip->jenis_kelamin) == 1 ? 'selected' : ''  }}>Laki-laki</option>
                                <option value="2" {{ old('jenis_kelamin',$kip->jenis_kelamin) == 2 ? 'selected' : ''  }}>Perempuan</option>
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="number" class="form-control @error('nominal') is-invalid @enderror" name="nominal" placeholder="Masukkan Nominal ..." value="{{ old('nominal', $kip->nominal) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_rekening') is-invalid @enderror" name="no_rekening" placeholder="Masukkan No Rekening ..." value="{{ old('no_rekening', $kip->no_rekening ) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="number" class="form-control @error('tahap_id') is-invalid @enderror" name="tahap_id" placeholder="Masukkan Tahap ID ..." value="{{ old('tahap_id', $kip->tahap_id) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nomor_sk') is-invalid @enderror" name="nomor_sk" placeholder="Masukkan Nomor SK ..." value="{{ old('nomor_sk', $kip->nomor_sk) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_sk') is-invalid @enderror" name="tanggal_sk" placeholder="Masukkan Tanggal SK ..." value="{{ old('tanggal_sk',$kip->tanggal_sk) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_rekening') is-invalid @enderror" name="nama_rekening" placeholder="Masukkan Nama Rekening ..." value="{{ old('nama_rekening', $kip->nama_rekening) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_cair') is-invalid @enderror" name="tanggal_cair" placeholder="Masukkan Tanggal Cair ..." value="{{ old('tanggal_cair', $kip->tanggal_cair) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('status_cair') is-invalid @enderror" name="status_cair" id="status_cair">
                                ...
                                <option value="1" {{ old('status_cair', $kip->status_cair) == 1 ? 'selected' : ''  }}>Cair</option>
                                <option value="2" {{ old('status_cair', $kip->status_cair) == 2 ? 'selected' : ''  }}>Belum cair</option>
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_kip') is-invalid @enderror" name="no_kip" placeholder="Masukkan NO KIP ..." value="{{ old('no_kip', $kip->no_kip) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_kks') is-invalid @enderror" name="no_kks" placeholder="Masukkan NO KKS ..." value="{{ old('no_kks', $kip->no_kks) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('no_kps') is-invalid @enderror" name="no_kps" placeholder="Masukkan NO KPS ..." value="{{ old('no_kps', $kip->no_kps) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('virtual_acc') is-invalid @enderror" name="virtual_acc" placeholder="Masukkan Virtual ACC ..." value="{{ old('virtual_acc', $kip->virtual_acc) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('nama_kartu') is-invalid @enderror" name="nama_kartu" placeholder="Masukkan Nama Kartu ..." value="{{ old('nama_kartu', $kip->nama_kartu) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="number" class="form-control @error('semester_id') is-invalid @enderror" name="semester_id" placeholder="Masukkan Semester ID ..." value="{{ old('semester_id', $kip->semester_id) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('layak_pip') is-invalid @enderror" name="layak_pip" id="layak_pip">
                                ...
                                <option value="1" {{ old('layak_pip', $kip->layak_pip) == 1 ? 'selected' : ''  }}>Ya</option>
                                <option value="2" {{ old('layak_pip'), $kip->layak_pip == 2 ? 'selected' : ''  }}>Tidak</option>
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('keterangan_pencairan') is-invalid @enderror" name="keterangan_pencairan" placeholder="Masukkan Keterangan Pencairan ..." value="{{ old('keterangan_pencairan',$kip->keterangan_pencairan) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('confirmation_text') is-invalid @enderror" name="confirmation_text" placeholder="Masukkan Confirmation Text ..." value="{{ old('confirmation_text', $kip->confirmation_text) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('tahap_keterangan') is-invalid @enderror" name="tahap_keterangan" placeholder="Masukkan Keterangan Tahap ..." value="{{ old('tahap_keterangan', $kip->tahap_keterangan) }}">
