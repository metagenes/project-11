...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('kisehat.store') }}" method="post">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('noka_bpjs') is-invalid @enderror" name="noka_bpjs" placeholder="Masukkan NOKA BPJS ..." value="{{ old('noka_bpjs') }}">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('psnoka_bpjs') is-invalid @enderror" name="psnoka_bpjs" placeholder="Masukkan PSNOKA BPJS ..." value="{{ old('psnoka_bpjs') }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" placeholder="Masukkan Status ..." value="{{ old('status') }}">
