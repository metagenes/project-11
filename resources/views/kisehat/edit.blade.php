                ...
                <div class="card shadow h-100">
                    <div class="card-header border-0">
                        <div class="d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between text-center text-md-left">
                            <div class="mb-3">
                                <h2 class="mb-0">Edit KIS</h2>
                                <p class="mb-0 text-sm">Kelola KIS</p>
                            </div>
                            <div class="mb-3">
                                <a href="{{ route("kisehat.index") }}" class="btn btn-success" title="Kembali"><i class="fas fa-arrow-left"></i> Kembali</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="row">
    <div class="col">
        <div class="card bg-secondary shadow h-100">
            <div class="card-body">
                <form autocomplete="off" action="{{ route('kisehat.update',$kisehat ) }}" method="post">
                    @csrf @method('patch')
                    <div class="row">
                        <div class="form-group col-12">
                            <label class="form-control-label" for="id_dtks">ID DTKS</label>
                            <input type="text" class="form-control @error('id_dtks') is-invalid @enderror" name="id_dtks" placeholder="Masukkan NIK ..." value="{{ old('id_dtks', $kisehat->id_dtks) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('dusun_id') is-invalid @enderror" name="dusun_id" id="dusun_id">
                                ...
                                @foreach ($dusun as $item)
                                    <option value="{{ $item->id }}" {{ old('dusun_id', $kisehat->dusun_id) == $item->id ? 'selected' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('rts_id') is-invalid @enderror" name="rts_id" id="rts_id">
                                ...
                                @foreach ($rts as $item)
                                    <option value="{{ $item->id }}" {{ old('rts_id', $kisehat->rts_id) == $item->id ? 'selected' : ''  }}>{{ $item->nomor }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select style="width: 100%;" class="form-control @error('rws_id') is-invalid @enderror" name="rws_id" id="rws_id">
                                ...
                                @foreach ($rws as $item)
                                    <option value="{{ $item->id }}" {{ old('rws_id', $kisehat->rws_id) == $item->id ? 'selected' : ''  }}>{{ $item->nomor }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-12">
                            ...
                            <textarea class="form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat" placeholder="Masukkan Alamat ...">{{ old('alamat', $kisehat->alamat) }}</textarea>
                            @error('alamat')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-md-6">
                            <label class="form-control-label" for="noka_bpjs">NOKA BPJS</label>
                            <input type="text" class="form-control @error('noka_bpjs') is-invalid @enderror" name="noka_bpjs" placeholder="Masukkan NIK ..." value="{{ old('noka_bpjs', $kisehat->noka_bpjs) }}">
                            @error('noka_bpjs')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-md-6">
                            <label class="form-control-label" for="psnoka_bpjs">PSNOKA BPJS</label>
                            <input type="text" class="form-control @error('psnoka_bpjs') is-invalid @enderror" name="psnoka_bpjs" placeholder="Masukkan NIK ..." value="{{ old('psnoka_bpjs', $kisehat->psnoka_bpjs) }}">
                            @error('psnoka_bpjs')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="nama">Nama</label>
                            <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" placeholder="Masukkan Nama ..." value="{{ old('nama', $kisehat->nama) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" name="tanggal_lahir" placeholder="Masukkan Tanggal Lahir ..." value="{{ old('tanggal_lahir', $kisehat->tanggal_lahir) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" name="tempat_lahir" placeholder="Masukkan Tempat Lahir ..." value="{{ old('tempat_lahir', $kisehat->tempat_lahir) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin">
                                ...
                                <option value="1" {{ old('jenis_kelamin', $kisehat->jenis_kelamin) == 1 ? 'selected' : ''  }}>Laki-laki</option>
                                <option value="2" {{ old('jenis_kelamin', $kisehat->jenis_kelamin) == 2 ? 'selected' : ''  }}>Perempuan</option>
                            </select>
                            @error('jenis_kelamin')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="nik">NIK</label>
                            <input type="text" class="form-control @error('nik') is-invalid @enderror" name="nik" placeholder="Masukkan NIK ..." value="{{ old('nik', $kisehat->nik) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <input type="text" class="form-control @error('kk') is-invalid @enderror" name="kk" placeholder="Masukkan KK ..." value="{{ old('kk', $kisehat->kk) }}">
                        ...
                        <div class="form-group col-lg-4 col-md-6">
                            ...
                            <select class="form-control @error('status_hubungan_dalam_keluarga_id') is-invalid @enderror" name="status_hubungan_dalam_keluarga_id" id="status_hubungan_dalam_keluarga_id">
                                ...
                                @foreach ($status_hubungan_dalam_keluarga as $item)
                                    <option value="{{ $item->id }}" {{ old('status_hubungan_dalam_keluarga_id', $kisehat->status_hubungan_dalam_keluarga_id) == $item->id ? 'selected' : ''  }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-lg-4 col-md-">
                            ...
                            <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" name="nama_ibu" placeholder="Masukkan Nama Ibu ..." value="{{ old('nama_ibu', $kisehat->nama_ibu) }}">
                            @error('nama_ibu')<span class="invalid-feedback font-weight-bold">{{ $message }}</span>@enderror
                        </div>
                        <div class="form-group col-lg-4 col-md-6">
                            <label class="form-control-label" for="status">Status</label>
                            <input type="text" class="form-control @error('status') is-invalid @enderror" name="status" placeholder="Masukkan Status ..." value="{{ old('status', $kisehat->status) }}">
        ...
        if ($("#dusun").val() != "") {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $("#detail_dusun_id").val("{{ $kisehat->detail_dusun_id }}");
                }
            });
        } else {
            $('#detail_dusun_id').html(`<option value="">Pilih RT/RW</option>`);
